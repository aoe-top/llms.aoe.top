# 使用 UnityGameUI 构建UI | 小莫的维基库

Source: https://wiki.aoe.top/ModTutorial/BepInEx/5.UnityGameUI.html
Friendly site: 小莫Wiki
Group: AOE.TOP
Fetched: 2026-06-18T02:28:54.056Z
Status: 200
...
GUILayout是运行在 OnGUI() 方法中，该方法会在每一帧都被调用，如果进行了数据调用，将浪费很多的资源，导致游戏卡顿。 UnityGameUI 是在游戏里面创建了一个 GameObject(游戏对象) ,你可以将他理解为一个厚度为0.0001的长方体，创建之后就一直在那里，通过 SetActive(true/false) 来控制是否显示, 在执行效率上没有效率的问题,显示设置为 false 之后也不会影响游戏的使用。
