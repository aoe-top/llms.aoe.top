# Installing a C++ Mod | 小莫的维基库

Source: https://wiki.aoe.top/ModTutorial/UE4SS/guides/installing-a-c++-mod.html
Friendly site: 小莫Wiki
Group: AOE.TOP
Fetched: 2026-06-18T02:26:57.364Z
Status: 200
...
- After building, you will have the following file: MyAwesomeMod.dll in MyMods\Binaries\ \MyAwesomeMod
- Navigate over to your game's executable folder and open the Mods folder. Here we'll do a couple things: Create a folder structure in Mods that looks like MyAwesomeMod\dlls .
...
- To enable loading of your mod in-game you will have to edit the mods.txt located in the Mods folder. By default it looks something like this:
