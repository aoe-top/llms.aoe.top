...
Source: https://wiki.aoe.top/ModTutorial/REFramework/api/json.html
Friendly site: 小莫Wiki
Group: AOE.TOP
Fetched: 2026-06-18T02:28:53.819Z
Status: 200
...
这是一份 Lua 值和 JSON 值之间转换的函数列表，非常有用，可以用来保存配置表（最好在一个 config save callback 中），导入用户打算在外部编辑的数据，以及将大型数据结构存储在 Lua 代码之外。
