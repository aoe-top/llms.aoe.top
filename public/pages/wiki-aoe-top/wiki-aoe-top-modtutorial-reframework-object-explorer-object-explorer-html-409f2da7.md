# Object Explorer | 小莫的维基库

Source: https://wiki.aoe.top/ModTutorial/REFramework/object_explorer/object_explorer.html
Friendly site: 小莫Wiki
Group: AOE.TOP
Fetched: 2026-06-18T02:29:09.445Z
Status: 200
...
- 在您的游戏文件夹中创建一个 il2cpp_dump.json
- 从 TDB 数据生成的 C++ 头文件和源文件的 sdk 文件夹
...
使用 il2cpp 转储的 Python 脚本可以在 这里 和 这里 找到。
