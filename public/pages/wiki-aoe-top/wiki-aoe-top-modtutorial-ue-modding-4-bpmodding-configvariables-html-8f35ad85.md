...
Source: https://wiki.aoe.top/ModTutorial/UE_Modding/4.BPModding/ConfigVariables.html
Friendly site: 小莫Wiki
Group: AOE.TOP
Fetched: 2026-06-18T02:29:05.761Z
Status: 200
...
- 导航到游戏的 engine.ini 文件，该文件位于： %localappdata%/ /saved/Config
- 使用文本编辑器打开名为 engine.ini 的文件并滚动到底部。
- 添加悬停在配置变量复选框上时显示的特定模式。
