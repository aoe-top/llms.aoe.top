...
Source: https://wiki.aoe.top/ModTutorial/UE_Modding/0.TheBasics/ExportingUModel.html
Friendly site: 小莫Wiki
Group: AOE.TOP
Fetched: 2026-06-18T02:29:05.451Z
Status: 200
...
UModel 通常用于浏览、查看和导出网格模型、骨骼网格、纹理、音频文件和配置文件。 对于更复杂和深入的资产，如蓝图和材质，请使用 FModel 。
...
- 将 替换为 UE4 版本，例如 -game=4.27 。
- 将 替换为游戏 Paks 文件夹的完整路径。
