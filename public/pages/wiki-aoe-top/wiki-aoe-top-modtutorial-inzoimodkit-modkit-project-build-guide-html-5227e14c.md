...
Source: https://wiki.aoe.top/ModTutorial/InZOIModKit/Modkit/project/Build/Guide.html
Friendly site: 小莫Wiki
Group: AOE.TOP
Fetched: 2026-06-18T02:26:57.483Z
Status: 200
...
- 启动Modkit
- 导入网格（根据情况选择）： a. 点击 导入静态网格 b. 点击 导入骨骼网格
- 选择准备好的FBX文件
- 检查导入设置
- 导入静态网格 ： 启用Nanite（推荐用于优化）
- 材质：可自动生成，但建议手动重新分配
- 导入骨骼网格 ： 材质曲线后缀
- Index[0]： .mat （用于将动画曲线值映射到材质参数）
- 点击 导入 → 网格加载完成
