# 配置 CMake 工具设置 | 小莫的维基库

Source: https://wiki.aoe.top/CMake/cmake-settings.html
Friendly site: 小莫Wiki
Group: AOE.TOP
Fetched: 2026-06-18T02:27:01.623Z
Status: 200
...
下表中支持替换的选项允许字符串出现变量引用。有关变量扩展的更多信息，请参见下面的 变量替换 。
...
cmake.configureArgs | 在配置过程中要传递给 CMake 的参数。宁愿使用 cmake.configureSettings 或 CMake variants 。不建议使用此设置传递 -D 参数。 | [] （空数组-无参数） | 是 |
...
cmake.defaultVariants | 重写没有变体文件时提供的默认变体集。请参阅 CMake variants 。 | | 否 |
