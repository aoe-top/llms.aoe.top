...
Source: https://wiki.aoe.top/ModTutorial/InZOIModKit/Modkit/project/CAZ/3.MaskinSystem.html
Friendly site: 小莫Wiki
Group: AOE.TOP
Fetched: 2026-06-18T02:26:59.027Z
Status: 200
...
- 创建 UV 通道 2（Create UV Channel 2）
- 将 UV 壳移动到正确的区域 ID 区域
- 使用参考线以避免不同区域之间的重叠
- 区域 ID 示例
...
- 在 "Covering Regions" 字段中添加个人或组 ID
