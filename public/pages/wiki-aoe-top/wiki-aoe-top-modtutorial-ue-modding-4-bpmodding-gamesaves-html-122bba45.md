...
Source: https://wiki.aoe.top/ModTutorial/UE_Modding/4.BPModding/GameSaves.html
Friendly site: 小莫Wiki
Group: AOE.TOP
Fetched: 2026-06-18T02:29:00.067Z
Status: 200
...
[!TIP] 存档文件存储在游戏目录的 Saved/SaveGames 文件夹中，该文件夹通常位于 AppData 目录下。这个目录可以被游戏更改，因此存档将被放置在与游戏存档相同的位置。
...
[!TIP] 为了避免多次创建引用，你可以在 BeginPlay 事件上创建引用。
...
[!TIP] 创建一个名为 SaveName 的字符串变量并将其设置为插槽名称。这样，你可以在一个位置轻松更改插槽名称。
