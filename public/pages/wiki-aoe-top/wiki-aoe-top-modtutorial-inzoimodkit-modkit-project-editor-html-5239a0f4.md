...
Source: https://wiki.aoe.top/ModTutorial/InZOIModKit/Modkit/project/editor.html
Friendly site: 小莫Wiki
Group: AOE.TOP
Fetched: 2026-06-18T02:26:57.147Z
Status: 200
...
- 当用户创建模组（如CAZ、建造或数据资产）时， 会自动在以下路径生成专用内容文件夹：
- 在此文件夹中，您可以找到用于实际模组开发的所有资源： 骨骼网格体
- 静态网格体
- 纹理
- 蓝图
- 数据资产（ .uasset 、 .json ）
