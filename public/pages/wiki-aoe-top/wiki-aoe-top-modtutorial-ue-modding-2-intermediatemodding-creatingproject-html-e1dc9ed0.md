...
Source: https://wiki.aoe.top/ModTutorial/UE_Modding/2.IntermediateModding/CreatingProject.html
Friendly site: 小莫Wiki
Group: AOE.TOP
Fetched: 2026-06-18T02:26:59.604Z
Status: 200
...
- 前往 UE4项目创建 。
- 前往 UE5项目创建 。
- 如果你的游戏使用IOStore，请参考 为Chunks配置UE5 。
(如果Paks文件夹中有 .ucas / .utoc 文件，则游戏使用了IOStore)
...
开始制作模组之前，一个重要的设置是在项目设置中禁用 共享材质着色器代码 。
这将确保你的自定义材质在游戏中正常工作。
