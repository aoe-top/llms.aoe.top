...
Source: https://wiki.aoe.top/ModTutorial/InZOIModKit/Modkit/project/CAZ/0.M_CAZ.html
Friendly site: 小莫Wiki
Group: AOE.TOP
Fetched: 2026-06-18T02:26:57.690Z
Status: 200
...
基础色贴图 | • 基础色纹理
• Alpha通道存储灰度基底，与自定义颜色(R/G/B)混合
• 默认灰度亮度约0.65 |

自定义颜色强度 | • 控制是否使用基于RGB遮罩的自定义颜色
0: 仅使用基础色
1: 使用自定义颜色 |
