...
Source: https://wiki.aoe.top/CMake/troubleshoot.html
Friendly site: 小莫Wiki
Group: AOE.TOP
Fetched: 2026-06-18T02:27:01.180Z
Status: 200
...
如果Debug按钮和Debug目标功能忽略了您的launch.json文件，请参阅 使用launch.json文件进行调试 。
...
CMake Tools提供了可选的日志记录，默认情况下未启用。使用 cmake.loggingLevel 设置来增加写入_CMake/Build_输出通道的输出量。
...
在提交问题或软件bug报告之前，请先检查 CMake Tools问题跟踪器 和 What's New ，看看是否已经解决了您的问题。如果问题没有被报告，请随时提交问题。

请访问 支持聊天室 。这是一个社区聊天室。微软不会监控它。
