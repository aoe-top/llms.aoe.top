# BepInEx的说明与介绍 | 小莫的维基库

Source: https://wiki.aoe.top/ModTutorial/BepInEx/1.README.html
Friendly site: 小莫Wiki
Group: AOE.TOP
Fetched: 2026-06-18T02:27:02.642Z
Status: 200
...
- 嵌入式安装
- 内置配置和日志
- 使用Harmony 补丁运行方法;[包括 Harmony 和 MonoMod ，用于启动时方法注入]
